...
const SAPIX_SCHEDULE = {
  ...
  '440-07': { name: '米と野菜',                             unitIds: ['SHA_GEO_CROP'],      subject: '社会' },
  '440-08': { name: '魚と肉',                               unitIds: ['SHA_GEO_FISHERY'],   subject: '社会' },
  '440-09': { name: '加工食品',                             unitIds: ['SHA_GEO_INDUSTRY'],  subject: '社会' },
  '440-10': { name: '日本の国土',                           unitIds: ['SHA_GEO_LAND'],      subject: '社会' },
  '440-11': { name: '日本の気候',                           unitIds: ['SHA_GEO_CLIMATE'],   subject: '社会' },
  '440-12': { name: '地図の見方①',                         unitIds: ['SHA_GEO_MAP'],       subject: '社会' },
  '440-13': { name: '地図の見方②',                         unitIds: ['SHA_GEO_MAP'],       subject: '社会' },
  '440-14': { name: '北海道地方',                           unitIds: ['SHA_GEO_HOKKAIDO'],  subject: '社会' },
  '440-15': { name: '東北地方',                             unitIds: ['SHA_GEO_TOHOKU'],    subject: '社会' },
  '440-16': { name: '関東地方',                             unitIds: ['SHA_GEO_KANTO'],     subject: '社会' },
  '440-17': { name: '中部地方①',                           unitIds: ['SHA_GEO_CHUBU'],     subject: '社会' },
  '440-18': { name: '中部地方②',                           unitIds: ['SHA_GEO_CHUBU'],     subject: '社会' },
  '440-19': { name: '近畿地方',                             unitIds: ['SHA_GEO_KINKI'],     subject: '社会' },
  '440-20': { name: '中国・四国地方',                       unitIds: ['SHA_GEO_CHUGOKU'],   subject: '社会' },
  '440-21': { name: '九州地方',                             unitIds: ['SHA_GEO_KYUSHU'],    subject: '社会' },
  '440-22': { name: '世界の中の日本',                       unitIds: ['SHA_NEWS_WORLD'],    subject: '社会' },
  '440-23': { name: '北海道の旅',                           unitIds: ['SHA_GEO_HOKKAIDO'],  subject: '社会' },
  '440-24': { name: '東北地方の旅',                         unitIds: ['SHA_GEO_TOHOKU'],    subject: '社会' },
  '440-25': { name: '関東地方の旅',                         unitIds: ['SHA_GEO_KANTO'],     subject: '社会' },
  '440-26': { name: '中部地方の旅',                         unitIds: ['SHA_GEO_CHUBU'],     subject: '社会' },
  '440-27': { name: '近畿地方の旅',                         unitIds: ['SHA_GEO_KINKI'],     subject: '社会' },
  '440-28': { name: '中国地方の旅',                         unitIds: ['SHA_GEO_CHUGOKU'],   subject: '社会' },
  '440-29': { name: '四国地方の旅',                         unitIds: ['SHA_GEO_CHUGOKU'],   subject: '社会' },
  '440-30': { name: '九州地方の旅',                         unitIds: ['SHA_GEO_KYUSHU'],    subject: '社会' },
  '440-31': { name: 'お米の国・日本',                       unitIds: ['SHA_GEO_CROP'],      subject: '社会' },
  '440-32': { name: '米作のいろいろな工夫',                 unitIds: ['SHA_GEO_CROP'],      subject: '社会' },
  '440-33': { name: '日本の米作の問題点',                   unitIds: ['SHA_GEO_CROP'],      subject: '社会' },
  '440-34': { name: 'いろいろな野菜作り',                   unitIds: ['SHA_GEO_CROP'],      subject: '社会' },
  '440-35': { name: 'いろいろな果物作り',                   unitIds: ['SHA_GEO_CROP'],      subject: '社会' },
  '440-36': { name: '麦・豆・いも類と工芸作物',             unitIds: ['SHA_GEO_CROP'],      subject: '社会' },
  '440-37': { name: '日本の畜産業',                         unitIds: ['SHA_GEO_LIVESTOCK'], subject: '社会' },
  '440-38': { name: '日本の農業の特徴',                     unitIds: ['SHA_GEO_CROP'],      subject: '社会' },
  '440-39': { name: '日本の水産業①日本と漁業',             unitIds: ['SHA_GEO_FISHERY'],   subject: '社会' },
  '440-40': { name: '日本の水産業②いろいろな漁業',         unitIds: ['SHA_GEO_FISHERY'],   subject: '社会' },
  '440-41': { name: '日本の水産業③魚を「育てる漁業」',     unitIds: ['SHA_GEO_FISHERY'],   subject: '社会' },
  '440-42': { name: '日本の森林と林業',                     unitIds: ['SHA_GEO_RESOURCE'],  subject: '社会' },
  '440-43': { name: '自然災害と防災へのとりくみ',           unitIds: ['SHA_GEO_CLIMATE'],   subject: '社会' },
  '440-44': { name: '工業の種類',                           unitIds: ['SHA_GEO_INDUSTRY'],  subject: '社会' },
  '440-45': { name: '金属工業と石油化学工業',               unitIds: ['SHA_GEO_INDUSTRY'],  subject: '社会' },
  '440-46': { name: '機械工業',                             unitIds: ['SHA_GEO_INDUSTRY'],  subject: '社会' },
  '440-47': { name: 'その他の工業',                         unitIds: ['SHA_GEO_INDUSTRY'],  subject: '社会' },
  '440-48': { name: '織物・染物・和紙・文具',               unitIds: ['SHA_GEO_CRAFT'],     subject: '社会' },
  '440-49': { name: '陶磁器・漆器・その他',                 unitIds: ['SHA_GEO_CRAFT'],     subject: '社会' },
  '440-50': { name: '４年生のまとめ',                       unitIds: [],                    subject: '社会' },
}
