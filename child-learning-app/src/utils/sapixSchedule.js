...
const SAPIX_SCHEDULE = {
  // ═══ 4年生 通常授業 Aテキスト（算数）═══════════════════════
  // 41A-01 は独自テーマ、41A-02 以降は前回 B テキストの復習
  '41A-01': { name: '割り算',                    unitIds: [], subject: '算数' },
  '41A-02': { name: '大きな数の復習',              unitIds: [], subject: '算数' },
  '41A-03': { name: '角と角度①の復習',             unitIds: [], subject: '算数' },
  '41A-04': { name: '植木算の復習',               unitIds: [], subject: '算数' },
  '41A-05': { name: '場合の数①の復習',             unitIds: [], subject: '算数' },
  '41A-06': { name: '総合（01～04）の復習',         unitIds: [], subject: '算数' },
  '41A-07': { name: '計算のくふうの復習',            unitIds: [], subject: '算数' },
  '41A-08': { name: '図形のせいしつの復習',           unitIds: [], subject: '算数' },
  '41A-09': { name: '和差算の復習',               unitIds: [], subject: '算数' },
  '41A-10': { name: '規則性の復習',               unitIds: [], subject: '算数' },
  '41A-11': { name: '総合（06～09）の復習',         unitIds: [], subject: '算数' },
  '41A-12': { name: '約数の復習',                unitIds: [], subject: '算数' },
  '41A-13': { name: '倍数の復習',                unitIds: [], subject: '算数' },
  '41A-14': { name: '面積の考え方①の復習',           unitIds: [], subject: '算数' },
  '41A-15': { name: '面積の考え方②の復習',           unitIds: [], subject: '算数' },
  '41A-16': { name: '総合（11～14）の復習',         unitIds: [], subject: '算数' },
  '41A-17': { name: '分数の基本の復習',             unitIds: [], subject: '算数' },
  '41A-18': { name: 'つるかめ算の復習',             unitIds: [], subject: '算数' },
  '41A-19': { name: '過不足算の復習',              unitIds: [], subject: '算数' },
  '41A-20': { name: '場合の数②の復習',             unitIds: [], subject: '算数' },
  '41A-21': { name: '和差算とやりとり算の復習',        unitIds: [], subject: '算数' },
  '41A-22': { name: '消去算の復習',               unitIds: [], subject: '算数' },
  '41A-23': { name: '小数の復習',                unitIds: [], subject: '算数' },
  '41A-24': { name: '分数の復習',                unitIds: [], subject: '算数' },
  '41A-25': { name: '総合（20～23）の復習',         unitIds: [], subject: '算数' },
  '41A-26': { name: '方陣算の復習',               unitIds: [], subject: '算数' },
  '41A-27': { name: '平均算の復習',               unitIds: [], subject: '算数' },
  '41A-28': { name: '円とおうぎ形①の復習',           unitIds: [], subject: '算数' },
  '41A-29': { name: '円とおうぎ形②の復習',           unitIds: [], subject: '算数' },
  '41A-30': { name: '総合（25～28）の復習',         unitIds: [], subject: '算数' },
  '41A-31': { name: '深さの変化の復習',             unitIds: [], subject: '算数' },
  '41A-32': { name: 'グラフの読み取り方の復習',        unitIds: [], subject: '算数' },
  '41A-33': { name: '規則性の復習',               unitIds: [], subject: '算数' },
  '41A-34': { name: '速さの復習',                unitIds: [], subject: '算数' },
